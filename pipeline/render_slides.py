...
# per-deal STORY slides (one tappable link sticker each, added at publish)
for i,x in enumerate(B["deals"],1):
    ...
    d.text((60,1600),"Tap the link sticker to open these exact dates",font=SANS(34),fill=WHITE)
